# Проект на С++ Лабиринт (Алгоритмы)
##
Знакомимся с лабиринтами, а также с основными алгоритмами их обработки, такими как: генерация, отрисовка, поиск решения

##
## Contents

1. [Chapter I - Краткая информация о лабиринтах](#chapter-i) 
2. [Chapter II - Требования к к реализации проекта Maze](#chapter-ii) 
3. [Chapter III - Реализации проекта Maze](#chapter-iii) 
    3.1. [Part 1 - Генерация идеального лабиринта ](#part-2-генерация-идеального-лабиринта) 
    3.2. [Part 2 - Решение лабиринта](#part-3-решение-лабиринта) 
...
## Генерация с использованием клеточного автомата - возможно не надо
...
##
## Chapter III - Реализации проекта Maze
